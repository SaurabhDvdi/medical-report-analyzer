...
export default function Medicines() {
  ...
  const fetchMedicines = async () => {
    ...
    try {
      ...
      setListError(
        error.response?.data?.detail || 'Could not load medicines.'
      )
    } finally {
      setLoading(false)
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (selectedMedicine) {
        await api.put(`/api/medicines/${selectedMedicine.id}`, payload)
      } else {
      ...
      alert(
        error.response?.data?.detail || 'Error saving medicine. Please try again.'
      )
    }
  }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      alert(
        error.response?.data?.detail || 'Error deleting medicine. Please try again.'
      )
    }
  }
